<template>
    ...
    <div class="col-9 ">
        ...
        <div class="col-12 mt-3 mb-3 text-center justify-content-center">
            <button v-if="show" @click="show=!show; name=''; updateId=undefined" class="btn btn-info">Add</button>
        </div>
                ...
                <table class="table">
                    ...
                    <template v-for="(edge, key) in edges.data" v-bind:key="key">
                        <tr :class="!isShow(edge.id) ? '' : 'd-none'">
                            ...
                            <td>{{ edge.name }}</td>
                            <td>
                                <a class="text-info" @click.prevent="changeId(edge.id, edge.name)">
                            ...
                            <td>
                                <a class="text-danger" @click.prevent="del(edge.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <tr :class="isShow(edge.id) ? '' : 'd-none'">
                            ...
                            <td>
                                <a class="text-info" @click.prevent="update(edge.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
export default {
    ...
    data() {
        return {
            ...
            err: '',
            show: true,
            url: this.$store.state.URL+'/api/admin/edges'
        }
    },
    methods: {
        add() {
