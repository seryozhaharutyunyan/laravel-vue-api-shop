        ...
        <div class="d-flex col-12 text-center justify-content-center">
            <div class="col-6">
                <table class="table">
                    ...
                    <template v-for="(tag, key) in tags.data" v-bind:key="key">
                        <tr :class="!isShow(tag.id) ? '' : 'd-none'">
                            <td>{{ key + 1 }}</td>
                            <td>{{ tag.title }}</td>
                            <td>
                                <a class="text-info" @click.prevent="changeId(tag.id, tag.title)">
                            ...
                            <td>
                                <a class="text-danger" @click.prevent="del(tag.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <tr :class="isShow(tag.id) ? '' : 'd-none'">
                            ...
                            <td>
                                <a class="text-info" @click.prevent="update(tag.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="col-12 text-center text-dark d-flex col-12 text-center justify-content-center">
                    <pagination :pagination="tags" :callback="getResults" :size="'small'">
...
export default {
    ...
    data() {
        return {
            ...
            err: '',
            show: true,
            url: this.$store.state.URL+'/api/admin/tags'
        }
    },
    methods: {
        add() {
