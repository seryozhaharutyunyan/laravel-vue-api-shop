        ...
        <div class="d-flex col-12 text-center justify-content-center">
            <div class="col-6">
                <table class="table">
                    ...
                    <template v-for="(value, key) in content.data" v-bind:key="key">
                        <tr :class="!isShow(category.id) ? '' : 'd-none'">
                            <td>{{ key + 1 }}</td>
                            <td>{{ value.title }}</td>
                            <td>
                                <a class="text-info" @click.prevent="changeId(value.id, value.title)">
                            ...
                            <td>
                                <a class="text-danger" @click.prevent="del(value.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <tr :class="isShow(value.id) ? '' : 'd-none'">
                            <td>{{ key + 1 }}</td>
                            <td>
                            ...
                            <td>
                                <a class="text-info" @click.prevent="update(value.id)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="col-12 text-center text-dark d-flex col-12 text-center justify-content-center">
                    <pagination :pagination="content" :callback="getResults" :size="'small'">
...
export default {
    ...
    methods: {
        add() {
            if (this.title === "") {
                this.err = 'title field is empty'
            } else if (this.title.length <= 2) {
                this.err = 'pole title cannot be beat shorter than 2 syngvols'
            } else {
